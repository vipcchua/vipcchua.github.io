...
//读取cookie
if(!getCookie("bg")) var index=0; 
else index=getCookie("bg");
var array= new Array("0.jpg","1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg"); 
$("body").css("background","url('/hexo-theme-huxblog/img/bk/"+array[index]+"') no-repeat fixed center top/cover transparent");
//右键事件
